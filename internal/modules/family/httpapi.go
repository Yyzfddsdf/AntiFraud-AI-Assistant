...
func RegisterRoutes(router *gin.RouterGroup, service UseCase) {
...
func createFamilyHandle(service UseCase) gin.HandlerFunc {
...
func getMyFamilyHandle(service UseCase) gin.HandlerFunc {
	return func(c *gin.Context) {
		userID, ok := resolveCurrentUserID(c)
		if !ok {
			return
...
func createInvitationHandle(service UseCase) gin.HandlerFunc {
	return func(c *gin.Context) {
		userID, ok := resolveCurrentUserID(c)
		if !ok {
			return
...
func listInvitationsHandle(service UseCase) gin.HandlerFunc {
	return func(c *gin.Context) {
		userID, ok := resolveCurrentUserID(c)
		if !ok {
			return
...
func listReceivedInvitationsHandle(service UseCase) gin.HandlerFunc {
	return func(c *gin.Context) {
		userID, ok := resolveCurrentUserID(c)
		if !ok {
			return
...
func acceptInvitationHandle(service UseCase) gin.HandlerFunc {
	return func(c *gin.Context) {
		userID, ok := resolveCurrentUserID(c)
		if !ok {
			return
...
func listMembersHandle(service UseCase) gin.HandlerFunc {
	return func(c *gin.Context) {
		userID, ok := resolveCurrentUserID(c)
		if !ok {
			return
...
func updateMemberHandle(service UseCase) gin.HandlerFunc {
	return func(c *gin.Context) {
		userID, ok := resolveCurrentUserID(c)
		if !ok {
			return
...
func deleteMemberHandle(service UseCase) gin.HandlerFunc {
	return func(c *gin.Context) {
		userID, ok := resolveCurrentUserID(c)
		if !ok {
			return
...
func createGuardianLinkHandle(service UseCase) gin.HandlerFunc {
	return func(c *gin.Context) {
		userID, ok := resolveCurrentUserID(c)
		if !ok {
			return
...
func listGuardianLinksHandle(service UseCase) gin.HandlerFunc {
	return func(c *gin.Context) {
		userID, ok := resolveCurrentUserID(c)
		if !ok {
			return
...
func deleteGuardianLinkHandle(service UseCase) gin.HandlerFunc {
	return func(c *gin.Context) {
		userID, ok := resolveCurrentUserID(c)
		if !ok {
			return
...
func notificationsWebSocketHandle(service UseCase) gin.HandlerFunc {
	return func(c *gin.Context) {
		userID, ok := resolveCurrentUserID(c)
		if !ok {
			return
...
func markNotificationReadHandle(service UseCase) gin.HandlerFunc {
	return func(c *gin.Context) {
		userID, ok := resolveCurrentUserID(c)
		if !ok {
			return
...
func runFamilyNotificationSession(ws *websocket.Conn, userID uint, service UseCase, runtimeCfg familyNotificationRuntimeConfig) {
